                	...
                	<div class="comment-form">
                        ...
                        <form action="updateM.do" method="POST" ><!-- 회원 정보 변경 -->
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="mid" value="로그:mid${member.mid }" readonly>
                            </div><br>
                            <p class="textAlignLeft">비밀번호 (변경가능)</p><hr>
                            <div class="form-group">
                                <input type="text" class="form-control" name="mpw" value="로그:mpw${member.mpw }">
                            </div><br>
                            <p class="textAlignLeft">이름</p><hr>
                            <div class="form-group">
                                <input type="text" class="form-control" name="mname" value="로그:mname${member.mname }" readonly>
                            </div><br>
                            <p class="textAlignLeft">전화번호</p><hr>
                            <div class="form-group">
                                <input type="text" class="form-control" name="mphone" value="로그:mphone${member.mphone }" readonly>
                            </div><br>
                            <p class="textAlignLeft">발 사이즈</p><hr>
                            <div class="form-group">
                                <input type="text" class="form-control" name="shoesSize" value="로그:shoesSize${member.shoesSize }" readonly>
                            </div><br>
                            <p class="textAlignLeft">주소</p><hr>
                            <div class="form-group">
                                <input type="text" class="form-control" name="maddress" value="로그:maddress${member.maddress } ${member.mdetailAddress }" readonly>
                            </div><br>
                            
                            <input type="submit" class="genric-btn primary e-large" value="비밀번호 수정" style="font-size:20px; background:black">
                        </form>
                         <br>
                         <a href="deleteM.do?${member.mid }" class="genric-btn primary small" style="font-size:15px; background:black">회원탈퇴</a>
                    </div>
                    <div class="comments-area">
                        ...
                        <div class="comment-list">
                            <div class="single-comment justify-content-between d-flex">
                                ...
                                <%-- foreach문 들어갈 자리 구매목록 출력 --%>
                                    <div class="thumb">
                                        <img src="img/shoes1.png" alt="" style="width:150px">
                                    </div>
                                    <div class="desc">
                                        <h5><a href="#">로그: 신발이름</a></h5>
                                        <p class="date">로그: 신발 컬러, 사이즈</p>
                                        <p class="comment">
                                            로그: 신발 배송지
                                        </p>
                                    </div>
                                ...
                                <div class="reply-btn">
                                    <a href="" class="btn-reply text-uppercase">후기작성</a>
                                </div>
                                <%--===============================--%>
