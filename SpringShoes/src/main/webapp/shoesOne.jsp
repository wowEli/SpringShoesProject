            ...
            <div class="col-lg-5 offset-lg-1">
               <div class="s_product_text">
                        ...
                        <form id="payform" action="pay.do" method="post">
                           <table class="table">
                              ...
                              <tbody class="slist">
                                 ...
                                 <!--                                     </td> -->
                                 <!--                                     <td> -->
                                 <!--                                        <h6>250</h6> <input type="hidden" name="sizepk"> -->
                                 <!--                                     </td> -->
                                 <!--                                     <td> -->
                                 <!--                                        <h6>1</h6> -->
                                 <!--                                     </td> -->
                  ...
                  <div class="card_area d-flex align-items-center">
                     <a class="primary-btn" onclick="payform()" style="color: black;">구매하기</a>
                     <a class="icon_btn" onclick="result()"><i
         ...
         $(".sizeButton")
               .click(
                     function() {
                        ...
                        var $td2 = $("<td><h6>" + $(this).html()
                              + "</h6></td>");
                        var $td3 = $("<input type='hidden' value='"
                              + $(this).val() + "' name='sizepk'>)");
                        var $td4 = $("<td><h6>1</h6></td>");
