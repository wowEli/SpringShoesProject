                    ...
                    <div class="col-lg-8">
                        ...
                        <form class="row contact_form" action="insertMember.do" method="post">
                            ...
                            <div class="col-md-4 form-group p_star">
                            	<span>이름</span>
                                <input type="email" class="form-control" id="mname" name="mname" placeholder="이름을 입력해 주세요">
                            </div>
                            <div class="col-md-8 form-group p_star">
                            </div>
                            ...
                            <div class="col-md-4 form-group p_star">
                            	<br>
                            	<input type="button" class="genric-btn primary-border radius" value="인증번호 전송">
                            </div>
                            <div class="col-md-6 form-group p_star">
                            	<span>인증번호</span>
                            ...
                            <div class="col-md-4 form-group p_star">
                                <br>
                                <input type="button" class="genric-btn primary-border radius" value="주소 찾기">
                            </div>
                            <div class="col-md-8 form-group p_star">
                            	<span>상세주소</span>
                            ...
                            <div class="col-md-6 form-group p_star">
                            	<span>참고항목</span>
                                <input type="text" class="form-control" id="mextraAddress" name="mextraAddress">
                            </div>
                            <div class="col-md-6 form-group p_star">
                            </div>                            
                            <div class="col-md-4 form-group p_star">
                            	<input type="submit" class="genric-btn primary-border e-large" value="회원가입하기">
                            </div>
                        </form>
                    </div>
                </div>
